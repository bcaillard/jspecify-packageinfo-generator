 ...
 * <p>This exception is used to wrap {@link IOException} instances that occur during the process of generating or writing a {@code package-info.java} file, providing additional context about the
 * failure.</p>
 */
