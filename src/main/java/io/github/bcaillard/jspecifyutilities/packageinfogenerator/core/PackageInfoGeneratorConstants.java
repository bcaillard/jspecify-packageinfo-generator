...
public class PackageInfoGeneratorConstants {
    ...
    public static final String MAIN_OUTPUT_DIRECTORY = "generated-sources/packages-info";
    public static final String TEST_OUTPUT_DIRECTORY = "generated-test-sources/packages-info";
