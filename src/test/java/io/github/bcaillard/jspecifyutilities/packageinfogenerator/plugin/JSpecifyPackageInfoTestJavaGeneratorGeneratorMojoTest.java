...
/** Tests for {@link io.github.bcaillard.jspecifyutilities.packageinfogenerator.plugin.JSpecifyPackageInfoTestJavaGeneratorGeneratorMojo}. */
@ExtendWith(MockitoExtension.class)
class JSpecifyPackageInfoTestJavaGeneratorGeneratorMojoTest {
    ...
    void should_invoke_Engine_run_with_correct_context() throws Exception {
        ...
        final io.github.bcaillard.jspecifyutilities.packageinfogenerator.plugin.JSpecifyPackageInfoTestJavaGeneratorGeneratorMojo mojo = new io.github.bcaillard.jspecifyutilities.packageinfogenerator.plugin.JSpecifyPackageInfoTestJavaGeneratorGeneratorMojo();
