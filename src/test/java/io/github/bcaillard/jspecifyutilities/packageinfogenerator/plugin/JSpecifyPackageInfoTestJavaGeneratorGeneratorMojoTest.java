...
/** Tests for {@link JSpecifyPackageInfoTestJavaGeneratorGeneratorMojo}. */
...
class JSpecifyPackageInfoTestJavaGeneratorGeneratorMojoTest {
    ...
    @Test
    void should_invoke_PackageInfoGeneratorEngine_and_add_generated_sources_to_test_compile_source() throws Exception {
        // Arrange
        ...
        final JSpecifyPackageInfoTestJavaGeneratorGeneratorMojo mojo = new JSpecifyPackageInfoTestJavaGeneratorGeneratorMojo();
        ...
        try (final MockedStatic<PackageInfoGeneratorEngine> mockedEngine = Mockito.mockStatic(PackageInfoGeneratorEngine.class)) {
            ...
            verify(mockProject).addTestCompileSourceRoot(anyString());
